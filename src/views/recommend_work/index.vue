...
const jobsData = ref([
  ...
  },
  {
    ...
    "kind2": "前端/移动开发",
    "kind3": "前端开发工程师",
    "description": "1、有扎实的前端基本功，编程能力够硬，了解先进开发方式，有实践经验。2、具备跨终端的前端开发能力，在Web（PC+Mobile）/Node.js/Hybrid App三个方向上至少精通一个方向，具备多个的更佳；3、精通React/Angular/WEEX等前端框架，熟悉源码和框架原理，熟悉前端工程化。4、至少熟悉一门非前端的语言（如Java/PHP/C/C++/Python/Ruby）5、具备良好的团队协作精神，能利用自身技术能力提升团队整体研发效率，提高团队影响力；6、对前端技术有持续的热情，个性乐观开朗，逻辑性强，善于和各种背景的人合作；",
    "province": "浙江省",
    "city": "杭州市",
    "district": "西湖区",
  ...
  },
  {
    ...
    "kind2": "前端/移动开发",
    "kind3": "前端开发工程师",
    "description": "工作内容：1、负责前端功能设计、开发和实现，保证产品的质量和开发进度；2、设计开发高效的前端组件，提高开发效率和维护成本；3、适应快速变化的需求，及时输出产品。岗位要求：1、大专及以上学历，计算机相关专业，3年以上前端开发工作经验；2、丰富的开发经验，熟悉react；3、能熟练使用Canvas等工具优先；4、扎实的计算机基础，具备较强的解决问题的能力，熟悉基础算法；5、对前端技术有持续的热情，个性乐观开朗，逻辑性强；",
    "province": "浙江省",
    "city": "杭州市",
    "district": "西湖区",
  ...
  },
  {
    ...
    "kind2": "前端/移动开发",
    "kind3": "前端开发工程师",
    "description": "岗位职责：1、负责移动端自动化脚本，PC web及App端的前端开发工作；2、与产品设计、开发人员紧密配合，准时、高效地完成模块功能；任职资格：1.精通JS，对闭包、事件和异步有深刻的见解，熟练手写原生JS代码，精通各种前端调试工具，熟悉JS性能优化。2.熟练使用移动端自动化脚本开发，有实际项目经验3.熟练使用vue开发，有实际项目经验4.熟悉gulp、webpack脚本配置。5.熟练使用svn、git代码管理工具。6.熟练使用html、css,精通css布局。7.熟悉H5混合开发，对前后端分离有独特见解，有实际项目经验8.良好的学习能力和沟通能力，编码稳健严谨，精益求精，对问题有探究精神",
    "province": "浙江省",
    "city": "杭州市",
    "district": "西湖区",
  ...
  },
  {
    ...
    "kind2": "前端/移动开发",
    "kind3": "前端开发工程师",
    "description": "岗位职责1. 负责公司整体前端项目开发、维护2. 参与前端产品需求讨论3. 与公司其他部门对接前端项目任职要求1. 熟练掌握HTML，CSS，JS2. 熟悉vue开发(vue全家桶)，适应H5，PC端项目及相关UI框架(element-ui为主)3. 对H5兼容性有一定了解，处理H5兼容问题4. 对HTTP有一定了解，axios封装5. 熟练使用GIT版本控制工具6. 掌握多语言开发，适配多语言开发下的样式问题7. 对视频，直播流，图片处理有所了解8. 了解node，npm，cocos",
    "province": "浙江省",
    "city": "杭州市",
    "district": "西湖区",
  ...
  },
  {
    ...
    "kind2": "前端/移动开发",
    "kind3": "前端开发工程师",
    "description": "任职要求：1. 3年以上 Web 前端开发经验，能独立完成单个模块的前端开发工作。2. 掌握 HTML, JavaScript / ES6, CSS 等前端基础技能，深刻理解 Web 应用的基本实现原理，掌握 HTTP 等基本协议，熟练对接后端 API。3. 精通React框架,以及全家桶。4. 有流行 UI 框架的使用经验，例如 Ant Design, Element-ui等。5. 有流行 图表框架的使用经验，例如 Echarts、AntV等。",
    "province": "浙江省",
    "city": "杭州市",
    "district": "西湖区",
  ...
  },
  {
    ...
    "kind2": "前端/移动开发",
    "kind3": "前端开发工程师",
    "description": "1.  负责智能家居系统APP开发与维护。2.  熟悉uniapp，MQTT，HTTP，JSON。3.  吃苦耐劳，有团队合作精神。4.  应届生优先考虑。 5. 双休，不加班，工作时间9:00～12:00，1:30～6:00。",
    "province": "浙江省",
    "city": "杭州市",
    "district": "西湖区",
