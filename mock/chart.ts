    ...
    response: (req: any) => {
      if (req.body.type === "skill") {
        return {
            ...
            jobsData: [
              {
                ...
                district: "临安市",
                address:
                  "杭州临安区中国(杭州)跨境电子商务综合试验区临安园区二期528",
                major: ["计算机"],
                neo4j: 8025,
                company: "嘉策信息",
          ...
          message: "Get Skill Recommend  Graph successfully",
        };
      } else {
        return {
          code: 200,
          ...
          message: "Get Other Recommend  Graph successfully",
        };
      }
    },
  },
